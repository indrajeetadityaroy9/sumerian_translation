"""
Line Matcher with Skeleton Similarity
...
CRITICAL: Uses skeleton similarity to prevent "Bag-of-Entities" fallacy.
Matching by entity pattern alone ignores syntax - we must check that
non-entity tokens are similar (≥ 85% Levenshtein similarity).
...
class LineMatcher:
    ...
    def __repr__(self) -> str:
        return (
            f"LineMatcher(attempts={self.stats['matches_attempted']}, "
