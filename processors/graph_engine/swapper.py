"""
Entity Swapper with Word Boundary Safety
...
from .builder import LineNode
from .matcher import LineMatch
...
class EntitySwapper:
    ...
    3. Type constraint enforcement via SafetyChecker
    """
    ...
    def __init__(self, safety_checker: Optional[SafetyChecker] = None):
        ...
        Args:
            safety_checker: SafetyChecker instance for type validation
        """
    ...
    def __repr__(self) -> str:
        return (
            f"EntitySwapper(attempted={self.stats['swaps_attempted']}, "
