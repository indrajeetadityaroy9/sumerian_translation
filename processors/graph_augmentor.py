...
class GraphAugmentor:
    ...
    def __init__(
        ...
        self.matcher: Optional[LineMatcher] = None
        self.swapper: Optional[EntitySwapper] = None
    ...
    def initialize(self, verbose: bool = True):
        ...
        # 2. Safety Checker
        safety = SafetyChecker(min_frequency=self.min_frequency)
        ...
        self.matcher = LineMatcher(self.graph)
        self.swapper = EntitySwapper(safety)
