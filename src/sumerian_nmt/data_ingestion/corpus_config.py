...
# Robust path resolution using central config
from sumerian_nmt.config import Paths

# Base paths - leverage central path resolution
BASE_DIR = Paths.ROOT
CORPUS_DIR = BASE_DIR / "etcsl_extractor" / "ota_20"  # Original ETCSL XML data location
